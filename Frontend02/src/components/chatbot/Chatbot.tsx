...
const Chatbot: React.FC = () => {
  ...
  const initializeChat = () => {
    const welcomeMessage: Message = {
      id: `msg-${Date.now()}`,
      type: 'bot',
      content: "Hi! 👋 Welcome to Agroreach Farmer Portal. I'm here to help you with selling products, managing stock, payments, verification, and more. How can I assist you today?",
      timestamp: new Date(),
    };
